        ...
        <div className="inner1024">
          <div className="txt_box">
            ...
            <div className="btn_wrap">
              <Link className="btn_style_carrot btn_download" to="https://play.google.com/store/apps/details?id=com.towneers.www" target="_blank">
                <img src={googlePlayImg} alt="구글 플레이에서 다운로드" />
                Google Play
              </Link>
              <Link className="btn_style_carrot btn_download" to="https://apps.apple.com/app/id1018769995" target="_blank">
